...
def display(candidate, startTime, boardWidth, boardHeight): 
    ...
    print("{}\n\t{}\t{}".format(' '.join(map(str, candidate.Genes)), 
...
class KnightsTests(unittest.TestCase):
    ...
    def test_3x4(self): 
        ...
        #   0   .   N   N   N
        #       0   1   2   3 
        self.find_knight_positions(self,width, height, 6)
    
    def test_8x8(self): 
        width = 8
        height = 8
        self.find_knight_positions(self,width, height, 14)
    
    def test_10x10(self): 
        width = 10
        height = 10
        self.find_knight_positions(self,width, height, 22)
